...
export default function ProductModal({ product, onClose }) {
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl relative"
        onClick={(e) => e.stopPropagation()}>
        <button
          className="absolute top-4 right-4 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 bg-white/50 dark:bg-gray-700/50 rounded-full p-1 transition-colors z-10"
          onClick={onClose}>
          <X className="w-6 h-6" />
        </button>
        ...
        <div className="p-6 space-y-4">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-gray-100 leading-tight">
                {product.name}
              </h2>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-base font-medium text-slate-900 dark:text-gray-100 capitalize">
            ...
            <div className="text-right">
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-24 mt-1 px-2 py-1 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded focus:outline-none focus:ring-2 focus:ring-pink-500 text-right"
                />
              ) : (
          ...
          {isEditing && (
            <div className="flex gap-3 mt-4">
              <button
                ...
                disabled={submitting}
                className="flex-1 bg-blue-600 dark:bg-blue-500 text-white py-2 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors flex items-center justify-center disabled:opacity-50">
                {submitting ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
                  <>
              ...
              <button
                ...
                disabled={submitting}
                className="flex-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 py-2 rounded-md hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
                Cancel
              </button>
            </div>
          )}
