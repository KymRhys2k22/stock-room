          ...
          <div>
            <div className="relative">
              ...
              <label
                ...
                className={`flex items-center justify-center gap-2 px-6 py-4 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${
                  uploading
            ...
            <p className="mt-2 text-xs text-gray-500">
              Images will be saved as: {sku}-1.png, {sku}-2.png, etc.
            </p>
          </div>
          ...
          {uploadedImages.length > 0 && (
            <div>
              <h3 className="text-xl font-bold text-slate-900 mb-4">
                Additional Images ({uploadedImages.length})
              </h3>
          ...
          {uploadedImages.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">
                Upload additional images for SKU:{" "}
